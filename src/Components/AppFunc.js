   ...
   setprogre(progresss);
    ...
    return (
      ...
      />
        <Switch>
          <Route exact  path="/">
          <NewsFunc setProgress={setProgress}  apikey="158ddd9ab30341eeba6da627e77254e4"  key="general"  pagesize={5} country="in" category="general"/>
          </Route>
          <Route exact  path="/entertainment">
          <NewsFunc setProgress={setProgress}  apikey="158ddd9ab30341eeba6da627e77254e4"  key="entertainement"  pagesize={5} country="in" category="entertainment"/>
          </Route>
